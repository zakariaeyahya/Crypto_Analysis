"""
Script de préparation de datasets alignés pour l'analyse Bitcoin/Sentiment 2021.

Ce script crée des datasets alignés sur la période 2021-02-05 → 2021-08-21
...
def create_output_directory(output_dir: str = "data/analysis_2021"):
    """
...
def load_and_filter_sentiment_data(
    ...
    start_date: str = "2021-02-05",
    end_date: str = "2021-08-21"
) -> pd.DataFrame:
    """
    Charge et filtre les données de sentiment Bitcoin sur la période 2021.
    ...
    Returns:
        DataFrame filtré sur la période 2021
    """
    ...
    # Filtrer sur la période 2021 (exclure 2018-03-23)
...
def load_and_filter_crypto_prices(
    ...
    """
    Charge et filtre les prix d'une cryptomonnaie sur la période 2021.
...
def create_btc_sentiment_dataset(
    ...
    output_dir: Path,
    filename: str = "btc_prices_sentiment_2021.csv"
) -> str:
    """
    Crée le dataset BTC + Sentiment pour 2021.
    ...
    """
    logger.info("Création du dataset BTC + Sentiment 2021...")
...
def create_multi_crypto_dataset(
    ...
    output_dir: Path,
    filename: str = "multi_crypto_prices_sentiment_2021.csv"
) -> str:
    """
    Crée le dataset multi-crypto (BTC, ETH, SOL) + Sentiment pour 2021.
    ...
    Returns:
        Chemin du fichier créé
    """
    logger.info("Création du dataset multi-crypto (BTC, ETH, SOL) + Sentiment 2021...")
...
def verify_datasets(btc_file: str, multi_file: str):
    ...
    # Vérifier btc_prices_sentiment_2021.csv
    ...
    # Vérifier multi_crypto_prices_sentiment_2021.csv
...
def main():
    ...
    """
    logger.info("="*60)
    logger.info("PRÉPARATION DES DATASETS ALIGNÉS 2021")
    logger.info("="*60)
    ...
    multi_crypto_file = create_multi_crypto_dataset(
        ...
        sol_prices_df,
        output_path,
        "multi_crypto_prices_sentiment_2021.csv"
    )
    ...
    logger.info(f"\nNote: sent_mean_global est NaN pour la plupart des jours 2021 (sera traité plus tard)")
